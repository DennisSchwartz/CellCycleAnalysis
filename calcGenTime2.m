...
%Added: Save number of cells per generation
genTimeDist.cellNmbrs = {};
...
for i = 1:numGens
   ...
   genTimeDist.cellNmbrs{1, i} = length(unique(tree.nonFluor.cellNr(tree.nonFluor.cellNr >= lowerBound & tree.nonFluor.cellNr <= upperBound)));
end
